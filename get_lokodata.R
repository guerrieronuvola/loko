...
col_names <- c("sex", "age", "GMFCS", "X.GMFM.tot.T0", "delta.GMFM.D", "delta.GMFM.E", "delta.gmfm66", "delta.6minWT", "delta.stance.medio.norm", "delta.gait.velocity.norm", "delta.step.length.media.norm")
